...
FASTA_DIRECTORY="/wynton/group/lynch/directory/with/fastq/files"

## Where do you want your data to end up?
RESULT_DIRECTORY="/wynton/group/lynch/directory/where/data/will/be/saved"
...
for i in $sampnames;
  do for j in 1 2;
     do
     cp ${i}_*_R${j}_001.fastq.gz $TMPDIR
